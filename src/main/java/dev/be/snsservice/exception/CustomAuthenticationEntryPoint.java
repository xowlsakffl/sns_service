...
public class CustomAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    @Override
    public void commence(final HttpServletRequest request, final HttpServletResponse response, AuthenticationException authException) throws IOException, ServletException {
